...
type ParametrizedNiceWebRoute<NestedRoutes> = (value?: string) => NestedNiceWebRoutes<NestedRoutes>;

type NestedNiceWebRoutes<NestedRouteDescription> = NestedRouteDescription extends NiceWebRoutesDescription<
	infer DescriptionShape
>
	? NiceWebRoutesNode<DescriptionShape>
	: never;

type ForbiddenNames = 'This key is reserved. You can not use reserved names as your route segment.';
...
type NiceWebRoutesDescriptionValue<MaybeObjectOrFunction> = MaybeObjectOrFunction extends () => infer FunctionResult
...
export type { NiceWebRoutesNode, ParametrizedNiceWebRoute, NestedNiceWebRoutes, NiceWebRoutesDescription };
